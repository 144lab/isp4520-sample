...
SPIClass SPI_FLASH(NRF_SPIM1, PIN_FLASH_MISO, PIN_FLASH_SCLK, PIN_FLASH_MOSI);

#define spi_xfer(n) SPI_FLASH.transfer(n)
...
uint32_t TinyFlash::begin(void) {
  ...
  // SPI_FLASH.setClockDivider(SPI_CLOCK_DIV16);  // 500 KHz
